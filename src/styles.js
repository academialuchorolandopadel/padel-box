...
export const S = {
  ...
  posGrid: { display: "grid", gridTemplateColumns: "minmax(0,1.3fr) minmax(0,1fr)", overflow: "hidden", flex: 1, minHeight: 0 },
  catalogo: { padding: 15, overflowY: "auto", borderRight: "1px solid #1c222b", minHeight: 0 },
  ...
  ticket: { display: "flex", flexDirection: "column", background: "#0e1218", minHeight: 0 },
  ...
  mesInput: { background: "#181f29", border: "1px solid #2a313c", color: "#eef0f3", borderRadius: 9, padding: "9px 11px", fontSize: 14, fontWeight: 700, colorScheme: "dark" },
  diaCard: { background: "#141a22", border: "1px solid #1c222b", borderRadius: 12, padding: "13px 15px", marginBottom: 10 },
  diaHead: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 8, textTransform: "capitalize" },
  diaFecha: { fontWeight: 700, fontSize: 14.5 },
  diaTotal: { fontWeight: 800, fontSize: 17, color: "#5fe0a1" },
  diaChips: { display: "flex", flexWrap: "wrap", gap: 7, marginBottom: 6 },
  diaChip: { display: "inline-flex", alignItems: "center", gap: 5, fontSize: 12.5, fontWeight: 700, borderRadius: 7, padding: "4px 9px", border: "1px solid" },
  diaFooter: { display: "flex", justifyContent: "space-between", fontSize: 13, color: "#8b93a0", marginTop: 6, paddingTop: 8, borderTop: "1px solid #1c222b" },
  ...
  conceptoRow: { display: "flex", alignItems: "center", gap: 10, padding: "11px 0", fontSize: 14.5, borderBottom: "1px solid #1c222b" },
  conceptoNom: { flex: 1, fontWeight: 600, minWidth: 0 },
  conceptoBar: { width: 64, height: 7, background: "#1d2530", borderRadius: 4, overflow: "hidden", flexShrink: 0 },
  conceptoMonto: { minWidth: 104, textAlign: "right", fontWeight: 800 },
  conceptoPct: { width: 40, textAlign: "right", fontSize: 12.5, color: "#7a808a", fontWeight: 700 },
  prodPlata: { minWidth: 92, textAlign: "right", fontWeight: 800, color: "#5fe0a1", fontSize: 13.5 },
  prodUn: { width: 44, textAlign: "right", fontSize: 12.5, color: "#8b93a0", fontWeight: 700 },
